...
export const T_DOOR = 3;   // bomb-destructible zone door (unused in 2-zone layout)
...
export function generateMap() {
  ...
  for (let r = 0; r < ROWS; r++) { map[r][13] = T_WALL; }
  map[7][13] = T_DOOR;  // bomb-destructible door — row 7 (odd = no pillar overlap)
